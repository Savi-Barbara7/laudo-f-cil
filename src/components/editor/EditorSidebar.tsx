          ...
          <div className="border-t border-sidebar-border px-2 py-2">
            ...
            {lindeiros.map((l, i) => (
              <button
                ...
                className="flex w-full items-center gap-2 rounded-md px-3 py-1.5 text-left text-xs text-sidebar-foreground/70 hover:bg-sidebar-accent/50"
              >
                <span className="flex h-5 w-5 items-center justify-center rounded bg-sidebar-accent text-[10px] font-bold">
                  {i + 1}
                </span>
